...
def evaluate_trajectory(
    ...
    # Increased epsilon slightly to provide a more robust margin against
    # floating point inaccuracies or strict validator checks.
    epsilon = 1e-4 # Changed from 1e-6
